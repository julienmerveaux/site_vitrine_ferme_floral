...
<!--    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#e3eeee" fill-opacity="1" d="M0,64L80,90.7C160,117,320,171,480,197.3C640,224,800,224,960,240C1120,256,1280,288,1360,304L1440,320L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>-->
...
loin... Je reviens donc à mon métier passionnant tout en produisant mes propres fleurs ! A la ferme florale Les 5 Saisons, les fleurs font un seul voyage.... De la
terre au bouquet"
